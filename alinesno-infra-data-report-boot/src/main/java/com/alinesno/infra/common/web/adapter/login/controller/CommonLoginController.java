...
//        ));
        ...
        Menu integrationMenu = new Menu("Report", "/Report", false, "noRedirect", "Layout", true, new Menu.Meta("数据上报服务", "system", false, null), List.of(
                new Menu("BusinessModel", "report/businessModel/list", false, false , "report/businessModel/list", new Menu.Meta("业务模型", "druid", false, null)),
                new Menu("FileRecycled", "report/fileRecycled/list", false, false , "report/fileRecycled/list", new Menu.Meta("回收站", "peoples", false, null)),
                new Menu("FileReport", "report/fileReport/list", false, false , "report/fileReport/list", new Menu.Meta("上报文件", "online", false, null)),
                new Menu("FileShare", "report/fileShare/list", false, false , "report/fileShare/list", new Menu.Meta("数据分享", "user", false, null)),
                new Menu("Message", "report/message/list", false, false , "report/message/list", new Menu.Meta("上报数据", "peoples", false, null)),
                new Menu("MessageFail", "report/messageFail/list", false, false , "report/messageFail/list", new Menu.Meta("上报异常", "druid", false, null)),
                new Menu("MessageHis", "report/messageHis/list", false, false , "report/messageHis/list", new Menu.Meta("上报历史数据", "peoples", false, null)),
                new Menu("Share", "report/fileShare/share", true, false , "/share/:shareBatchNum?", new Menu.Meta("分享文件", "peoples", false, null))
        ));
